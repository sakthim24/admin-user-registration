        ...
        <div className="relative py-10 min-h-3/4 w-10/12 min-w-3/4 md:w-4/12  mx-auto text-center">
          <div className="bg-purple-600 md:relative mt-4 shadow-lg w-100 sm:rounded-lg text-left">
            <div className="py-1 md:py-6 px-8">
              <h1 className="text-center mb-3 md:mb-4 block font-medium md:font-extrabold text-2xl text-grey-500">My Profile</h1>
           {  userstat.map((stat) => {
            ...
            <div className="mb-4 font-medium">
              ...
              <div className="flex mt-3 md:mt-0 items-center justify-center">
                <button
                  className="bg-white hover:bg-purple-800 text-black h-3 md:h-10 text-md md:text-base font-bold py-1 px-4 rounded focus:outline-none focus:shadow-outline"
